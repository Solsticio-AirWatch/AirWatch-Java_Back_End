...
public class UsersController {
    ...
    private final AuthenticationManager authenticationManager; // Adicionado aqui para quebrar o ciclo!
    ...
    public ResponseEntity<AuthResponse> login(@RequestBody @Valid AuthRequest req) {
        // O Controller valida as credenciais usando o manager da SecurityConfig
        authenticationManager.authenticate(
                new UsernamePasswordAuthenticationToken(req.email(), req.password())
        );

        // Se passar, o service apenas monta o token
